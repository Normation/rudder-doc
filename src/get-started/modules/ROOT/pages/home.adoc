...
* Discover Rudder
** xref:8.3@reference:ROOT:index.adoc[What is Rudder]Discover Rudder features and use cases
...
* Install Rudder
** xref:8.3@reference:installation:requirements.adoc[Requirements]Requirement for Rudder installation
...
** xref:8.3@reference:installation:server/debian.adoc[Install Rudder server]Install a Rudder root server to define your configuration policies
...
** xref:8.3@reference:installation:agent/debian.adoc[Install Rudder agent]Install a Rudder agent to apply configuration

* Use Rudder
** xref:8.3@reference:ROOT:index.adoc[User manual]Reference documentation
