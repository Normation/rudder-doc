...
| in the form zone_global, zone_foo, zone_baz...
...
Please note that this syntax is not available in Technique Editor. The preferred method in Technique Editor si to use `Variable String with Default`
