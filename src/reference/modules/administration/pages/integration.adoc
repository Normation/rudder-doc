...
The Rudder plugin is part of Ansible community inventory plugins as of version 2.0 (but also works with previous versions).
...
* A valid API token. It only needs to be able to read groups and nodes inventory data.
