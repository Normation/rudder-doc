...
wget https://LOGIN:PASSWORD@download.rudder.io/rpm/8.0/AIX_5/ppc/rudder-agent-8.0.0-1.AIX.5.3.aix5.3.ppc.rpm
...
rpm -ivh rudder-agent-8.0.0-1.AIX.5.3.aix5.3.ppc.rpm
