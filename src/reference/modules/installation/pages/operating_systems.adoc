...
| OS | Version | Architecture
.2+| Debian | 10*, 11, 12 and 13 | 64bit, arm64, armhf (Raspbian)
| 10*, 11 and 12 | 32bit
.2+| Ubuntu | 18.04*, 20.04, 22.04, 24.04 and 26.04 LTS | 64bit
| 18.04* LTS | 32bit
.2+| Red Hat Enterprise Linux (RHEL) / RHEL-like (CentOS, etc) | 7*, 8, 9 and 10 | 64bit
| 9 and 10 | arm64
.1+| SUSE Linux Enterprise Server (SLES) | 12sp5+\*, 15sp2*, 15sp3*, 15sp4+ and 16 | 64bit
| Amazon Linux | 2*, 2023 | 64bit
| Slackware | 15* | 64bit
...
Operating systems marked with a * are only supported with an additional extended support subscription. Please contact the Rudder team for more information.
====
...
* The latest Ubuntu LTS versions (plus the previous one if the latest is less than 9 month)
