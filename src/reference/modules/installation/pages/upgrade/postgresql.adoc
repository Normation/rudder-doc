...
This simplified PostgreSQL documentation. If in doubt, please always refer to the officiel PostgreSQL documentation https://www.postgresql.org/docs/
...
Rudder 7.2 needs PortgreSQL 10.3.
...
Be careful with versions, we are upgrading postgresql from `OldVersion` to `NewVersion`. It is up to you to check that V1 is the version wher your data is stored and V2 is the version you want to upgrade to.
