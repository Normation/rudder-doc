...
If you upgrade from 6.x and you changed the default cetificate, you will need to change the Apache2 configuration. Read the xref:notes.adoc#_changed_default_certificate_upgrade[guidelines] to change the default certificate in 7.x.
====

== PostgreSQL upgrade

Please check that your PostgreSQL is at least on version 10.3 befor upgrading to Rudder 7.2.
...
== Upgrade from Rudder 6.1 or 6.2 to 7.2
