...
== Upgrade from Rudder 8.3 or 9.0 to 9.1

Upgrade from Rudder 8.3 or 9.0 is supported.

=== End of support for old operating systems

Rudder 9 no longer supports installation on the following operating systems, for servers and relays:
