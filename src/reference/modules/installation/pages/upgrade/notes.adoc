...
Rudder 6 comes with a new reporting protocol using HTTPS instead of syslog. It is enabled by default on
...
Direct upgrades from 5.0 versions older than 5.0.16, 4.3.x and older are no longer supported on 6.1.
