...
* For a slower major upgrade pace, Rudder subscription provides (among other benefits) *long-term maintenance up to 24 months after release* (depending on the subscription level) for Rudder versions. You can read more about it on the https://www.rudder.io/en/rudder/subscription/[subscription page].

Note: The ESR tag was previously given to major releases that were maintained 6 months after the next ESR version was announced. Rudder 4.1 is the last ESR release, extended maintenance is now provided as part of https://www.rudder.io/en/rudder/subscription/[Rudder subscription].

You can subscribe to the https://www.rudder-project.org/site/community/mailing-lists/<Paste>[rudder-announce mailing-list] to receive release and end of life announcements. Here is a table of all versions of Rudder, their status, release dates and planned maintenance termination date:
