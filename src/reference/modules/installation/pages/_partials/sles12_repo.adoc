...
zypper ar -n 'Rudder 8.1' http://repository.rudder.io/rpm/8.1/SLES_12/ Rudder
...
zypper ar -n 'Rudder 8.1' https://LOGIN:PASSWORD@download.rudder.io/rpm/8.1/SLES_12/ Rudder
