...
zypper ar -n 'Rudder 9.1' http://repository.rudder.io/rpm/9.1/SLES_12/ Rudder
...
zypper ar -n 'Rudder 9.1' https://LOGIN:PASSWORD@download.rudder.io/rpm/9.1/SLES_12/ Rudder
