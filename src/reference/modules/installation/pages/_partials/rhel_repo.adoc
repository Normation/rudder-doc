...
echo '[Rudder_7.0]
name=Rudder 7.0
baseurl=http://repository.rudder.io/rpm/7.0/RHEL_$releasever/
gpgcheck=1
...
username=LOGIN
password=PASSWORD
baseurl=http://download.rudder.io/rpm/7.0/RHEL_$releasever/
gpgcheck=1
...
echo '[Rudder_7.0]
name=Rudder 7.0
baseurl=https://LOGIN:PASSWORD@download.rudder.io/rpm/7.0/RHEL_$releasever/
gpgcheck=1
