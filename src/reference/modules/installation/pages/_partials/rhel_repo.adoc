...
echo '[Rudder_9.2]
name=Rudder 9.2
baseurl=http://repository.rudder.io/rpm/9.2/RHEL_<VERSION>/
gpgcheck=1
...
username=LOGIN
password=PASSWORD
baseurl=http://download.rudder.io/rpm/9.2/RHEL_<VERSION>/
gpgcheck=1
...
echo '[Rudder_9.2]
name=Rudder 9.2
baseurl=https://LOGIN:PASSWORD@download.rudder.io/rpm/9.2/RHEL_<VERSION>/
gpgcheck=1
