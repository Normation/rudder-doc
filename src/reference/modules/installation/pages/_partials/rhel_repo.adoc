...
echo '[Rudder_9.1]
name=Rudder 9.1
baseurl=http://repository.rudder.io/rpm/9.1/RHEL_<VERSION>/
gpgcheck=1
...
username=LOGIN
password=PASSWORD
baseurl=http://download.rudder.io/rpm/9.1/RHEL_<VERSION>/
gpgcheck=1
...
echo '[Rudder_9.1]
name=Rudder 9.1
baseurl=https://LOGIN:PASSWORD@download.rudder.io/rpm/9.1/RHEL_<VERSION>/
gpgcheck=1
