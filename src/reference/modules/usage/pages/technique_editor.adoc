...
NOTE: The description field of a technique support markdown format and will be displayed in xref:reference:usage:configuration_management.adoc#_directives[Directives] who are using it.
