...
This plugins allows to manage Windows systems, using Microsoft Powershell DSC. Rudder Windows agent is available with a annual subscription, read more about the subscription here: https://www.rudder.io/en/pricing/subscription/
