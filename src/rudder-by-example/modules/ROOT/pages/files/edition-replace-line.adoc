...
Managing the values of key->value lines is the easiest use case, by using the generic methods xref:reference:reference:generic_methods.adoc#file_key_value_present[file_key_value_present],
xref:reference:reference:generic_methods.adoc#file_key_value_present_option[file_key_value_present_option] or even more complex use cases xref:reference:reference:generic_methods.adoc#file_key_value_parameter_present_in_list[file_key_value_parameter_present_in_list].
