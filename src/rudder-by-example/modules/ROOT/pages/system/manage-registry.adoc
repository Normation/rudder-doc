...
Microsoft Powershell documentation https://learn.microsoft.com/en-us/powershell/scripting/samples/working-with-registry-entries?view=powershell-7.5#creating-new-registry-entries[here].
