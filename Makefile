...
all: $(GENERIC_DOCS) build/history/8.1/.htaccess build/sites/site/.htaccess $(VERSION_ARCHIVES) build/files test
online: site site-dev build/sites/site/.htaccess build/history/8.1/.htaccess $(VERSION_ARCHIVES) build/files
